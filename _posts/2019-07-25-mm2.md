...
## Recapping molecular modeling
Remember, our **model** from a molecular modeling perspective is the **potential energy**, which depends
...
For example, if you had 3 coins, you could have a macrostate consisting of 2 Tails and 1 Head. The corresponding microstates might be HTT, THT, TTH
...
## Monte Carlo methods
Monte carlo (MC) sampling is not unique to molecular simulation, but molecular modelers do like to implement MC methods.
...
There are lots of different algorithms, but a common one in the molecular modeling field is the **Metropolis-Hastings** algorithm
